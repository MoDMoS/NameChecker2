...
import th.ac.kmutnb.namechecker.databinding.ActivityNavMenu2Binding;
...
public class Nav_Menu2 extends AppCompatActivity {

    private AppBarConfiguration mAppBarConfiguration;
    private ActivityNavMenu2Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityNavMenu2Binding.inflate(getLayoutInflater());
        setContentView(binding.getRoot());

        setSupportActionBar(binding.appBarNavMenu2.toolbar);
        DrawerLayout drawer = binding.drawerLayout2;
        navigationView = binding.navView2;
        // Passing each menu ID as a set of Ids because each
        // menu should be considered as top level destinations.
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_student_main, R.id.nav_addclass_Student, R.id.nav_logout)
                .setOpenableLayout(drawer)
                .build();
        NavController navController = Navigation.findNavController(this, R.id.nav_host_fragment_content_nav_menu2);
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        for (int i=0; i < response.length(); i++ ) {
                            try {
                                ...
                                TextView navUsername = (TextView) headerView.findViewById(R.id.Name_S);
                                TextView navId = (TextView) headerView.findViewById(R.id.T_id2);
